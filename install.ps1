# install.ps1 - instala todo lo necesario para Escalator.
#   - paquete Python (CLI + UI) con sus dependencias
...
Write-Host "=== Escalator: instalacion ===" -ForegroundColor Cyan
...
Write-Host "      paquete 'escalator' instalado."
...
if (Test-Path ".env") {
    ...
    Write-Host "      EDITA .env y pon tus claves ANTHROPIC_API_KEY y GOOGLE_API_KEY." -ForegroundColor Yellow
}

Write-Host ""
Write-Host "=== Listo ===" -ForegroundColor Green
Write-Host "  Prueba barata:   .\run-cli.ps1     (elige modo prueba)"
